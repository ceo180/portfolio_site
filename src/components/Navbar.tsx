...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 inset-x-0 z-50 px-4 sm:px-6 py-4 sm:py-6 mix-blend-difference text-white pointer-events-auto"
    >
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <Link
          href="/"
          onClick={(e) => handleNavClick(e, "hero")}
          className="font-bold text-lg md:text-xl tracking-tighter uppercase cursor-pointer pointer-events-auto py-2 flex items-center min-h-[44px]"
